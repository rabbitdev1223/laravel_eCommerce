<div>
    ...
    <div class="m-0" wire:key='faq-{{ $faqItem->id }}'>
        <div class="d-flex align-items-center collapsible py-3 toggle mb-0 collapsed" data-bs-toggle="collapse" data-bs-target="#kt_support_{{ $faqItem->id }}" aria-expanded="false">
            ...
            <div class="d-flex align-items-center flex-wrap">
                <h3 class="text-gray-800 fw-bold cursor-pointer me-3 mb-0">{{ $faqItem->question }}</h3>
            </div>
        </div>
        <div id="kt_support_{{ $faqItem->id }}" class="fs-6 ms-10 collapse" style="">
            <div class="mb-4">
                <span class="text-muted fw-bold fs-5">{{ $faqItem->answer }}</span>
            </div>
        </div>
    </div>
    @endforeach
