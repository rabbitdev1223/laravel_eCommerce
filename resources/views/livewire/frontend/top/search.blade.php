<div data-kt-search-element="wrapper">
    <!--begin::Form-->
    <form wire:submit.prevent data-kt-search-element="form"
        class="{{ $products->count() > 0 && $search != '' ? 'mb-3' : '' }} w-100 position-relative" autocomplete="off">
        <!--begin::Icon-->
    ...
    <div class="mb-4" data-kt-search-element="main">
        ...
        <div class="mb-4 d-flex flex-stack fw-bold">
            <!--begin::Label-->
            <span class="text-muted fs-6 me-2">Results:</span>
            <!--end::Label-->
        </div>
        <!--end::Heading-->
        <!--begin::Items-->
        <div class="scroll-y mh-200px mh-lg-325px">
            ...
            <div class="mb-5 d-flex align-items-center">
                ...
                <div class="symbol symbol-40px me-4">
                    <img src="{{ route('images', ['size'=>40,'image_id'=>$product->image_id]) }}"
                ...
                <div class="d-flex flex-column">
                    <a href="{{ route('products.show', $product) }}"
                        class="text-gray-800 fs-6 text-hover-primary fw-bold">{{ $product->title }}</a>
                    <span class="fs-7 text-muted fw-bold">{{ $product->formattedCategories() }}</span>
                </div>
                <!--end::Title-->
            </div>
            <!--end::Item-->
