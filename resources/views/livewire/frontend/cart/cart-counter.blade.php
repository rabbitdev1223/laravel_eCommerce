<div wire:ignore.self class="btn btn-icon btn-active-light-primary " data-kt-menu-trigger="click"
    data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end" data-kt-menu-flip="bottom" myAttribute>
    @if ($cartCount)
    <span class="badge badge-light-primary badge-circle fw-bolder fs-7">{{ $cartCount ? $cartCount : '0' }}</span>
    @endif
