                    ...
                    <div class="card-xl-stretch me-md-6">
                        <div class="d-block overlay">
                            <a class="d-block overlay" data-fslightbox="lightbox-hot-sales" href="{{ route('products.show', $product) }}">
                                <div class="overlay-wrapper bgi-no-repeat bgi-position-center bgi-size-cover card-rounded min-h-300px" style="background-image:url('{{ route('images', ['image_id' => $product->image->id, 'size' => '345']) }}')"></div>
                        ...
                        <div class="mt-3 d-flex flex-column">
                            <a href="{{ route('products.show', $product) }}"
                               class="fs-4 text-dark fw-bolder text-hover-primary text-dark lh-base d-block h-50px overflow-hidden">{{ $product->title }}</a>
