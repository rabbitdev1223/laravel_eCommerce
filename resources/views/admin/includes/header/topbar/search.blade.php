    ...
    <div id="kt_header_search" class="d-flex align-items-stretch" data-kt-search-keypress="true"
        ...
        <div data-kt-search-element="content" class="menu menu-sub menu-sub-dropdown p-7 w-325px w-md-375px">
                ...
                <div class="mb-4" data-kt-search-element="main">
                    ...
                    <div class="scroll-y mh-200px mh-lg-325px">
                        ...
                        <div class="mb-5 d-flex align-items-center">
                            ...
                            <!--begin::Title-->
                            <div class="d-flex flex-column">
                                <a href="#" class="text-gray-800 fs-6 text-hover-primary fw-bold">BoomApp
                                    by Keenthemes</a>
                        ...
                        <div class="mb-5 d-flex align-items-center">
                            ...
                            <!--begin::Title-->
                            <div class="d-flex flex-column">
                                <a href="#" class="text-gray-800 fs-6 text-hover-primary fw-bold">"Kept
                        ...
                        <div class="mb-5 d-flex align-items-center">
                            ...
                            <!--begin::Title-->
                            <div class="d-flex flex-column">
                                <a href="#" class="text-gray-800 fs-6 text-hover-primary fw-bold">"KPI
                        ...
                        <div class="mb-5 d-flex align-items-center">
                            ...
                            <!--begin::Title-->
                            <div class="d-flex flex-column">
                                <a href="#" class="text-gray-800 fs-6 text-hover-primary fw-bold">"FitPro
                                    App Development</a>
                                <span class="fs-7 text-muted fw-bold">#84250</span>
                            </div>
                            <!--end::Title-->
                        ...
                        <div class="mb-5 d-flex align-items-center">
                            ...
                            <!--begin::Title-->
                            <div class="d-flex flex-column">
                                <a href="#" class="text-gray-800 fs-6 text-hover-primary fw-bold">Shopix
                                    Mobile App</a>
                        ...
                        <div class="mb-5 d-flex align-items-center">
                            ...
                            <!--begin::Title-->
                            <div class="d-flex flex-column">
                                <a href="#" class="text-gray-800 fs-6 text-hover-primary fw-bold">"Landing
                                    UI Design" Launch</a>
            ...
            <form data-kt-search-element="preferences" class="pt-1 d-none">
                ...
                <div class="py-4 border-bottom">
                    <label class="form-check form-switch form-switch-sm form-check-custom form-check-solid flex-stack">
                        <span class="text-gray-700 form-check-label fs-6 fw-bold ms-0 me-2">Affiliate
                            Programs</span>
