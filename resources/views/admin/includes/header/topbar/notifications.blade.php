        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade" id="kt_topbar_notifications_1" role="tabpanel">
                ...
                <div class="px-8 my-5 scroll-y mh-325px">
                    ...
                    <div class="py-4 d-flex flex-stack">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Title-->
                            <div class="mb-0 me-2">
                                <a href="#" class="text-gray-800 fs-6 text-hover-primary fw-bolder">Project
                                    Alice</a>
                    ...
                    <div class="py-4 d-flex flex-stack">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Title-->
                            <div class="mb-0 me-2">
                                <a href="#" class="text-gray-800 fs-6 text-hover-primary fw-bolder">HR
                                    Confidential</a>
                    ...
                    <div class="py-4 d-flex flex-stack">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Title-->
                            <div class="mb-0 me-2">
                                <a href="#" class="text-gray-800 fs-6 text-hover-primary fw-bolder">Company
                                    HR</a>
                    ...
                    <div class="py-4 d-flex flex-stack">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Title-->
                            <div class="mb-0 me-2">
                                <a href="#" class="text-gray-800 fs-6 text-hover-primary fw-bolder">Banner
                                    Assets</a>
                    ...
                    <div class="py-4 d-flex flex-stack">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Title-->
                            <div class="mb-0 me-2">
                                <a href="#" class="text-gray-800 fs-6 text-hover-primary fw-bolder">Icon
                                    Assets</a>
                ...
                <div class="py-3 text-center border-top">
                    <a href="pages/profile/activity.html" class="btn btn-color-gray-600 btn-active-color-primary">View
                        All
            ...
            <div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
                ...
                <div class="d-flex flex-column px-9">
                    ...
                    <div class="pt-10 pb-0">
                        ...
                        <!--end::Title-->
                        <!--begin::Text-->
                        <div class="pt-1 text-center text-gray-600 fw-bold">Outlines keep
                    ...
                    <div class="px-4 text-center">
                        <img class="mw-100 mh-200px" alt="metronic"
                            src="{{ asset('assets/media/illustrations/work.png') }}" />
                    </div>
                    <!--end::Illustration-->
                </div>
                <!--end::Wrapper-->
