...
<body>
    {{-- Header --}}
    @if($invoice->logo)
    <img src="{{ $invoice->getLogo() }}" alt="logo" height="25">
    @endif
        ...
        <tbody>
            <tr>
                ...
                <td class="pl-0 border-0">
                    ...
                    --}}
                    {{-- <p>PO #: <strong>{{ $invoice->getSerialNumber() }}</strong></p> --}}
                    <p>PO#: <strong>{{ $invoice->getCustomData() }}</strong></p>

                    {{-- <p>{{ __('invoices::invoice.date') }}: <strong>{{ $invoice->getDate() }}</strong></p> --}}
                    <p>Order created: <strong>{{ $invoice->getDate() }}</strong></p>
                </td>
            </tr>
        </tbody>
    </table>
