    ...
    if (null != e) {
        var r = { overlay: !0, direction: "end", baseClass: "drawer", overlayClass: "drawer-overlay" },
            ...
            d = function () {
                var e = g(),
                    t = f("direction");
                !0 === KTUtil.hasClass(n.element, n.options.baseClass + "-on") && "on" === String(i.getAttribute("data-kt-drawer-" + n.name + "-")) ? (n.shown = !0) : (n.shown = !1),
                    !0 === f("activate")
                        ? (KTUtil.addClass(n.element, n.options.baseClass), KTUtil.addClass(n.element, n.options.baseClass + "-" + t), KTUtil.css(n.element, "width", e, !0), (n.lastWidth = e))
                        : (KTUtil.css(n.element, "width", ""), KTUtil.removeClass(n.element, n.options.baseClass), KTUtil.removeClass(n.element, n.options.baseClass + "-" + t), s());
            },
            c = function () {
                !0 === f("overlay") &&
    ...
    window.addEventListener("resize", function () {
        ...
        KTUtil.throttle(
            ...
            function () {
                ...
                if (t && t.length > 0) for (var n = 0, i = t.length; n < i; n++) KTDrawer.getInstance(t[n]).update();
            },
            200
        );
    }),
            ...
            E = function (e) {
                if (!1 !== KTEventHandler.trigger(n.element, "kt.menu.dropdown.show", e)) {
                    ...
                    null !== a && a >= o && (o = a + 1),
                        ...
                        !0 === x(e, "overflow") ? (document.body.appendChild(t), KTUtil.data(e).set("sub", t), KTUtil.data(t).set("item", e), KTUtil.data(t).set("menu", n)) : KTUtil.data(t).set("item", e),
            ...
            w = function (e) {
                if (!1 !== KTEventHandler.trigger(n.element, "kt.menu.dropdown.hide", e)) {
                    ...
                    KTUtil.css(t, "z-index", ""),
                        ...
                        !0 === x(e, "overflow") && (e.classList.contains("menu-item") ? e.appendChild(t) : KTUtil.insertAfter(n.element, e), KTUtil.data(e).remove("sub"), KTUtil.data(t).remove("item"), KTUtil.data(t).remove("menu")),
                        k(e),
            ...
            y = function (e) {
                ...
                return {
                    ...
                    modifiers: [
                        ...
                        { name: "preventOverflow", options: { rootBoundary: "clippingParents" } },
                        { name: "flip", options: { altBoundary: !0, fallbackPlacements: i } },
                    ],
                };
            },
            S = function (e) {
...
var KTPlace = function (e, t) {
    ...
    if (null != e) {
        ...
        !0 === KTUtil.data(e).has("place") ? (n = KTUtil.data(e).get("place")) : r(),
            (n.update = function () {
                o();
            }),
            (n.on = function (e, t) {
...
(KTPlace.getInstance = function (e) {
    ...
    (KTPlace.createInstances = function (e) {
        var t = document.querySelectorAll(e);
        if (t && t.length > 0) for (var n = 0, i = t.length; n < i; n++) new KTPlace(t[n]);
    }),
    window.addEventListener("resize", function () {
        KTUtil.throttle(
            undefined,
            function () {
                ...
                if (e && e.length > 0) for (var t = 0, n = e.length; t < n; t++) KTPlace.getInstance(e[t]).update();
            },
            200
        );
    }),
    ...
    "loading" === document.readyState ? document.addEventListener("DOMContentLoaded", KTPlace.init) : KTPlace.init(),
    "undefined" != typeof module && void 0 !== module.exports && (module.exports = KTPlace);
var KTScroll = function (e, t) {
    ...
    if (e) {
        var i = { saveState: !0 },
            ...
            a = function () {
                var e, t;
                !0 === u("activate") || !1 === n.element.hasAttribute("data-kt-scroll-activate")
                    ? ((e = d()),
                      null !== (t = l()) && t.length > 0 ? KTUtil.css(n.element, e, t) : KTUtil.css(n.element, e, ""),
                      !0 === u("save-state") && void 0 !== KTCookie && n.id ? n.element.addEventListener("scroll", o) : n.element.removeEventListener("scroll", o),
                      (function () {
                ...
                if (null !== i && (e = document.querySelectorAll(i)) && e.length > 0)
                    for (var a = 0, l = e.length; a < l; a++) {
                        ...
                        !1 !== KTUtil.visible(s) &&
                            ...
                            KTUtil.css(s, "border-top") && (t -= parseInt(KTUtil.css(s, "border-top"))),
    ...
    window.addEventListener("resize", function () {
        ...
        KTUtil.throttle(
            ...
            function () {
                ...
                if (t && t.length > 0) for (var n = 0, i = t.length; n < i; n++) KTScroll.getInstance(t[n]).update();
            },
            200
        );
    }),
...
var KTScrolltop = function (e, t) {
    ...
    if (null != e) {
        ...
        KTUtil.data(e).has("scrolltop") ? (n = KTUtil.data(e).get("scrolltop")) : o(),
            (n.go = function () {
                return s();
            }),
            (n.getElement = function () {
        ...
        var i = { minLength: 2, keypress: !0, enter: !0, layout: "menu", responsive: null, showOnFocus: !0 },
            ...
            o = function () {
                n.inputElement.addEventListener("focus", a),
                    ...
                    !0 === p("keypress") && n.inputElement.addEventListener("input", u),
                    n.submitElement && n.submitElement.addEventListener("click", d),
                    !0 === p("enter") && n.inputElement.addEventListener("keypress", s),
...
var KTSticky = function (e, t) {
    var n = this,
        i = document.getElementsByTagName("BODY")[0];
    if (null != e) {
        var r = { offset: 200, reverse: !1, animation: !0, animationSpeed: "0.3s", animationClass: "animation-slide-in-down" },
            o = function () {
                (n.element = e),
                    (n.options = KTUtil.deepExtend({}, r, t)),
                ...
                !1 !== r &&
                    ...
                    !0 === o
                        ? (t > r && n.lastScrollTop < t
                              ? (!1 === i.hasAttribute(n.attributeName) && (l(), i.setAttribute(n.attributeName, "on")),
                              ...
                              : (!0 === i.hasAttribute(n.attributeName) && (s(), i.removeAttribute(n.attributeName)),
            ...
            l = function (e) {
                ...
                if (
                    ...
                    null !== o && (KTUtil.css(n.element, "z-index", o), KTUtil.css(n.element, "position", "fixed")),
        ...
        !0 === KTUtil.data(e).has("sticky") ? (n = KTUtil.data(e).get("sticky")) : o(),
            (n.update = function () {
    ...
    window.addEventListener("resize", function () {
        ...
        KTUtil.throttle(
            ...
            function () {
                ...
                if (t && t.length > 0) for (var n = 0, i = t.length; n < i; n++) KTSticky.getInstance(t[n]).update();
            },
            200
        );
    }),
    ...
    return {
        init: function () {
            (e = document.querySelector("#kt_header_search")) &&
                ...
                a == null ? null : a.addEventListener("click", function () {
                    i.classList.add("d-none"), o.classList.remove("d-none");
                }),
                l == null ? null : l.addEventListener("click", function () {
                    i.classList.remove("d-none"), o.classList.add("d-none");
                }),
               u == null ? null : u.addEventListener("click", function () {
                    i.classList.add("d-none"), s.classList.remove("d-none");
                }),
                d == null ? null : d.addEventListener("click", function () {
                    i.classList.remove("d-none"), s.classList.add("d-none");
                }),
               c == null ? null :  c.addEventListener("click", function () {}));
        },
    };
})();
KTUtil.onDOMContentLoaded(function () {
